...
public class PatientSettingsFragment extends Fragment {
    ...
    public void changeIntent(Class cls){
        Intent i=new Intent(this.getActivity(),cls);
        startActivity(i);
    }
    public void onViewCreated(View v,Bundle savedState){
        MaterialCardView btnPatientLogOut=(MaterialCardView) v.findViewById(R.id.button_patient_settings_logout);
        btnPatientLogOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                User.CurrentUser=null;
                Doctor.CurrentDoctor=null;
                Patient.CurrentPatient=null;
                changeIntent(Login_Spinner.class);
            }
        });
    }
}